...
const homeFaq = [
  ...
  },
  {
    ...
    answer:
      "Sim, nossa equipe é especializada e possui as ferramentas adequadas para o manuseio, corte e assentamento seguro de porcelanatos de grandes formatos (lastras), garantindo acabamento perfeito.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "A forma de fornecimento dos materiais é definida no orçamento. Geralmente, o cliente fornece o revestimento/porcelanato e nós incluímos argamassa, rejunte e niveladores ou definimos isso conforme a preferência.",
  },
  {
  ...
  "@graph": [
    {
      ...
      "@id": `${company.domain}/porcelanato/#business`,
      name: company.name,
      url: `${company.domain}/porcelanato`,
      description: "Serviço especializado de assentamento de porcelanato e revestimentos em São Paulo.",
    ...
    {
      "@type": "WebSite",
      "@id": `${company.domain}/porcelanato/#website`,
      url: `${company.domain}/porcelanato`,
      name: company.name,
      description: company.description,
      publisher: { "@id": `${company.domain}/porcelanato/#business` },
      inLanguage: "pt-BR",
    },
  ],
};

export default function PorcelanatoLandingPage() {
  return (
    <>
      {/* JSON-LD */}
      <script
      ...
      >
        {/* Background photo */}
        <Image
          src="/hero-porcelanato.jpg"
          alt="Profissionais de assentamento de porcelanato"
          fill
          priority
          sizes="100vw"
        ...
        <div className="container-site relative z-10 py-4 lg:py-6 flex flex-col items-center justify-center text-center h-full">
          <div className="max-w-3xl flex flex-col items-center gap-4 lg:gap-5">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-1 justify-center items-center w-full sm:w-auto">
              <a
                href={whatsappUrl(whatsappMessages.porcelanato)}
                target="_blank"
      ...
      <section className="section-padding bg-[var(--color-warm-white)]" aria-labelledby="services-title">
        <div className="container-site">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {[
              ...services.filter((s) => s.slug === "porcelanato"),
              ...services.filter((s) => s.slug !== "porcelanato"),
            ].map((s) => (
              <ServiceCard
                key={s.slug}
        ...
        <div className="container-site relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-[var(--color-light-gray)] text-lg leading-relaxed mb-10">
              O diferencial da nossa equipe não está apenas em aplicar o material, mas em todo o processo de preparação, nivelamento, recortes precisos e técnica de dupla colagem para garantir alta durabilidade.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-left mb-10">
              {[
                "Dupla colagem para peças grandes",
                "Planejamento de paginação e paginação limpa",
                "Uso de niveladores profissionais",
                "Cortes em 45 graus e acabamento perfeito",
              ].map((item) => (
